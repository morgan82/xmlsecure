...
import org.globallogic.xmlsec.Decrypter;

import java.io.PrintWriter;
import java.io.StringWriter;

public class SimpleJavaCalloutDecrypt implements Execution{
	public ExecutionResult execute(MessageContext messageContext, ExecutionContext executionContext) {
		try
		{
			String xmlString = Decrypter.decriptXml(messageContext.getMessage().getContent(),"testaio1.pem");
